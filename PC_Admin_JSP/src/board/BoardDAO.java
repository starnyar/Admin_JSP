...
public class BoardDAO {
	...
	public List<BoardDTO> readDBList(int pageNo, int pageLine, String cond,
									String ctext){
		...
		if(cond != null) 
		{
			...
			if(cond.equals("all") && ctext != "") {
				whereCondition = " where writer like '%" + ctext + "%'" + " or title like '%" + ctext + "%'";
			}
			else if((cond.equals("writer")||cond.equals("title")) && ctext != "") {
